...
(function () {
    ...
    const upload_ipt = document.querySelector('.upload7 .fileIpt');
    const upload_button_select = document.querySelector('.upload7 .selectFile');
    const upload_button_upload = document.querySelector('.upload7 .up');
    const upload_progress = document.querySelector('.upload7 .progress');
